...
<div class="limiter">
    <div class="container-login100" style="background-image:url( '{{ asset('images/bg-01.jpg')}}' );">
        <div class="wrap-login100">
            <form class="login100-form validate-form" method="POST" id="myForm" action="{{ route('register') }}">
                @csrf
                ...
                <div class="wrap-input100 validate-input" data-validate = "Enter username">
                    <input class="input100 @error("name") is-invalid @enderror" type="text" name="name" placeholder="name" value="{{ old('name') }}">
