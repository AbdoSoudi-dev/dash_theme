                    ...
                    <table id="example23"
                        ...
                        <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td><?php echo e($client->mobile_number); ?></td>
                                <td><?php echo e($client->user->name); ?></td>
                                <td class="text-center" style="cursor:pointer;">
                                    <a href="<?php echo e(route("users_data/{$client->id}")); ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo e(route("users_data")); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\dash_cms\resources\views/data_table.blade.php ENDPATH**/ ?>