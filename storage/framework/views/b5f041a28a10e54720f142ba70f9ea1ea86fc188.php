...
<head>
    ...
    <!--===============================================================================================-->
    <link rel="stylesheet" type="text/css" href="<?php echo e(url('fonts/iconic/css/material-design-iconic-font.min.css')); ?>">
    <!--===============================================================================================-->
...
<div class="limiter">
    <div class="container-login100" style="background-image:url( '<?php echo e(asset('images/bg-01.jpg')); ?>' );">
        <div class="wrap-login100">
            <form class="login100-form validate-form" method="POST" id="myForm" action="<?php echo e(route('register')); ?>">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" type="text" name="name" placeholder="name" value="<?php echo e(old('name')); ?>">
...
unset($__errorArgs, $__bag); ?>" type="text" name="email" placeholder="email" value="<?php echo e(old('email')); ?>">
                    <span class="focus-input100" data-placeholder="&#xf207;"></span>
...
<?php /**PATH C:\xampp\htdocs\dash_cms\resources\views/auth/register.blade.php ENDPATH**/ ?>