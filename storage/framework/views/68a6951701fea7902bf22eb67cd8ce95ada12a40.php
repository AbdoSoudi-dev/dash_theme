...
<div class="limiter">
    <div class="container-login100" style="background-image:url( '<?php echo e(asset('images/bg-01.jpg')); ?>' );">
        <div class="wrap-login100">
            <form class="login100-form validate-form" method="POST" id="myForm" action="<?php echo e(route('login')); ?>">
                <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\dash_cms\resources\views/auth/login.blade.php ENDPATH**/ ?>