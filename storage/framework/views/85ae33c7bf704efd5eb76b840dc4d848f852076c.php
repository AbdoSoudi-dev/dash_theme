                            ...
                            <div class="carousel-inner">
                                <div class="carousel-item active">
                                    ...
                                    <div class="d-flex no-block">
                                        <span><img src="<?php echo e(url('assets/images/users/1.jpg')); ?>" alt="user" width="50" class="img-circle"></span>
                                        <span class="m-l-10">
                                ...
                                <div class="carousel-item">
                                    <h4 class="cmin-height">My Acting blown <span class="font-medium">Your Mind</span> and you also <br/>laugh at the moment</h4>
                                    <div class="d-flex no-block">
                                        <span><img src="<?php echo e(url('assets/images/users/2.jpg')); ?>" alt="user" width="50" class="img-circle"></span>
                                        <span class="m-l-10">
                                        <h4 class="text-white m-b-0">Govinda</h4>
                                        <p class="text-white">Actor</p>
                                        </span>
                                ...
                                <div class="carousel-item">
                                    <h4 class="cmin-height">My Acting blown <span class="font-medium">Your Mind</span> and you also <br/>laugh at the moment</h4>
                                    <div class="d-flex no-block">
                                        <span><img src="<?php echo e(url('assets/images/users/3.jpg')); ?>" alt="user" width="50" class="img-circle"></span>
                                        <span class="m-l-10">
                                        <h4 class="text-white m-b-0">Govinda</h4>
                                        <p class="text-white">Actor</p>
                                        </span>
...
<div class="row">
    ...
    <div class="col-lg-6">
        <div class="card">
            ...
            <!-- Comment widgets -->
            <!-- ============================================================== -->
            <div class="comment-widgets" id="comment" style="height: 679px;position: relative;">
                <!-- Comment Row -->
                <div class="d-flex no-block comment-row">
                    <div class="p-2"><span class="round"><img src="<?php echo e(url('assets/images/users/1.jpg')); ?>" alt="user" width="50"></span></div>
                ...
                <div class="d-flex no-block comment-row border-top">
                    <div class="p-2"><span class="round"><img src="<?php echo e(url('assets/images/users/2.jpg')); ?>" alt="user" width="50"></span></div>
                ...
                <!-- Comment Row -->
                <div class="d-flex no-block comment-row border-top">
                    <div class="p-2"><span class="round"><img src="<?php echo e(url('assets/images/users/3.jpg')); ?>" alt="user" width="50"></span></div>
                    <div class="comment-text w-100">
                ...
                <!-- Comment Row -->
                <div class="d-flex no-block comment-row border-top">
                    <div class="p-2"><span class="round"><img src="<?php echo e(url('assets/images/users/4.jpg')); ?>" alt="user" width="50"></span></div>
                    <div class="comment-text active w-100">
                ...
                <div class="to-do-widget m-t-20" id="todo" style="height: 400px;position: relative;">
                    ...
                    <ul class="list-task todo-list list-group m-b-0" data-role="tasklist">
                        <li class="list-group-item" data-role="task">
                            ...
                            <ul class="assignedto">
                                <li><img src="<?php echo e(url('assets/images/users/1.jpg')); ?>" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Steave"></li>
                                <li><img src="<?php echo e(url('assets/images/users/2.jpg')); ?>" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Jessica"></li>
                                <li><img src="<?php echo e(url('assets/images/users/3.jpg')); ?>" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Priyanka"></li>
                                <li><img src="<?php echo e(url('assets/images/users/4.jpg')); ?>" alt="user" data-toggle="tooltip" data-placement="top" title="" data-original-title="Selina"></li>
                            </ul>
                        </li>
                        <li class="list-group-item" data-role="task">
                            <div class="custom-control custom-checkbox">
    ...
    <div class="col-md-4">
        <div class="card">
            <div class="card-body">
                ...
                <div class="message-box d-block" id="msg" style="height: 430px;position: relative;">
                    <div class="message-widget message-scroll">
                        <!-- Message -->
                        <a href="javascript:void(0)">
                            <div class="user-img"> <img src="<?php echo e(url('assets/images/users/1.jpg')); ?>" alt="user" class="img-circle"> <span class="profile-status online pull-right"></span> </div>
                        ...
                        <!-- Message -->
                        <a href="javascript:void(0)">
                            <div class="user-img"> <img src="<?php echo e(url('assets/images/users/2.jpg')); ?>" alt="user" class="img-circle"> <span class="profile-status busy pull-right"></span> </div>
                            <div class="mail-contnet">
                        ...
                        <!-- Message -->
                        <a href="javascript:void(0)">
                            <div class="user-img"> <img src="<?php echo e(url('assets/images/users/4.jpg')); ?>" alt="user" class="img-circle"> <span class="profile-status offline pull-right"></span> </div>
                            <div class="mail-contnet">
            ...
            <div class="card-body">
                ...
                <div class="chat-box" id="chat" style="height: 327px;position: relative;">
                    ...
                    <ul class="chat-list">
                        <!--chat Row -->
                        <li>
                            <div class="chat-img"><img src="<?php echo e(url('assets/images/users/1.jpg')); ?>" alt="user"></div>
                        ...
                        <!--chat Row -->
                        <li>
                            <div class="chat-img"><img src="<?php echo e(url('assets/images/users/2.jpg')); ?>" alt="user"></div>
                            <div class="chat-content">
                                <h5>Bianca Doe</h5>
                        ...
                        <!--chat Row -->
                        <li>
                            <div class="chat-img"><img src="<?php echo e(url('assets/images/users/3.jpg')); ?>" alt="user"></div>
                            <div class="chat-content">
...
<script>
    $(function () {
        ...
        $.toast({
            heading: 'Hello <?php echo e(auth()->user()->name); ?>'
            , text: 'Welcome back'
            , position: 'top-right'
            , loaderBg: '#ff6849'
            , icon: 'info'
...
<?php /**PATH C:\xampp\htdocs\dash_cms\resources\views/welcome.blade.php ENDPATH**/ ?>