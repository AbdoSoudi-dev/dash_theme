                        ...
                        <?php $__currentLoopData = $clients; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $key =>$client): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); ?>
                            <tr>
                                ...
                                <td class="text-center d-flex justify-content-between" style="cursor:pointer;" >
                                    <a href="<?php echo e(url("edit_client/{$client->id}")); ?>">
    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form method="POST" action="<?php echo e(route("clients")); ?>">
                    <?php echo csrf_field(); ?>
...
<?php /**PATH C:\xampp\htdocs\dash_cms\resources\views/clients.blade.php ENDPATH**/ ?>